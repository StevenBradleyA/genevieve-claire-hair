            ...
            <div className="flex w-full justify-between">
                <div className="flex flex-col gap-2 ">
                    <Image
                        alt="logo"
                        src={heart}
                        className="image-black-to-white h-12 w-12 object-contain"
                    />
                    <p className="w-80">
                ...
                <div className="relative flex w-96 flex-col items-center overflow-hidden ">
                    <Image
                        alt="giraffe logo"
                        src={giraffe}
                    ...
                    <AnimatePresence>
                        {giraffeIndex >= 1 && (
                            <motion.button
                                className="absolute right-0 top-0 rounded-full bg-white text-purple-300"
                                key={0}
                            >
                                hey
                            </motion.button>
                        ...
                        {giraffeIndex >= 2 && (
                            <motion.button
                                className="absolute bottom-0 left-0 rounded-full bg-white text-purple-300"
                                key={1}
                            >
                                hey
                            </motion.button>
                        ...
                        {giraffeIndex >= 3 && (
                            <motion.button
                                className="absolute bottom-0 right-0 rounded-full bg-white text-purple-300"
                                key={2}
                            >
                                hey
                            </motion.button>
                        ...
                        {giraffeIndex >= 4 && (
                            <motion.button
                                className="absolute left-0 top-0 rounded-full bg-white text-purple-300"
                                key={3}
                            >
                                hey
                            </motion.button>
                        ...
                        {giraffeIndex === 5 && (
                            <motion.button
                                className="absolute bottom-12 left-1/2 w-full -translate-x-1/2 whitespace-nowrap font-dancing-script  text-3xl text-purple-300"
                                key={4}
                            >
                                BOOK AN APPOINTMENT
                            </motion.button>
                ...
                <div className="flex flex-col items-start gap-1">
                    <h2 className=" text-xl text-fuchsia-100">Explore</h2>
                    <Link
                        href="/bookings"
